...
if time_bound == "yes" and priority in ["high", "medium"]:
    reminder_message = f"{reminder_message} that requires immediate attention today!"
elif time_bound == "yes" and priority == "low":
    reminder_message = f"'{task}' is a **low** priority task, but it requires immediate attention today!"
